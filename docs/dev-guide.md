...
| `ready` | Expose `game["naruto-d20-kaihou"].TwentyQuestionsWizard`; register school/occupation auto-apply hooks |
| `renderActorSheetPFCharacter` | Inject 20Q biography section + wizard button |
