"""Tests for skill-key-mapping exhaustiveness against vault YAMLs.

Validates that every class_skills slug in the vault village YAML files
(Mechanics/Character_Options/Villages/*.yaml) has a corresponding entry
